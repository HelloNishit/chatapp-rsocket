      ...
      this.fireAndForgetClient.connect().subscribe({
        onComplete: socket => {
          socket
            .fireAndForget({
              data: chatMessage,
              metadata: String.fromCharCode('sendSubscribeChatMessage'.length) + 'sendSubscribeChatMessage'
            });
        },
        onError: error => {
          ...
          onComplete: socket => {
            socket
              .requestStream({
                ...
                metadata: String.fromCharCode('subscribeChatMessage'.length) + 'subscribeChatMessage'
              })
              .subscribe({
